...
def fully_connected_variational(layer_sizes, n_particles, is_training):
    ...
    w0 = layers.fully_connected(w0, 450)
    w0 = layers.fully_connected(w0, 450, activation_fn=None)
    w0 = tf.reshape(w0, [n_particles, 1, 50, 9])
...
if __name__ == '__main__':
    ...
    info_file_handler = logging.FileHandler('logs/avb_bnn_split/'+dataset_name+'_100.log')
